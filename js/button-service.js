var ButtonsService = {
  init: function(){
    $('#addMaterialForm').validate({
      submitHandler:function(form){
        var button = Object.fromEntries((new FormData(form)).entries());
        ButtonsService.add(button);
      }
    });//JQUERY VALIDATION
    ButtonsService.list();
  },
  ...
  list: function(){
    $.get("rest/services/buttons/", function( data ){
      $("#buttons-list").html("");
      var html="";
        ...
        <div class="col-lg-3" style="padding:15px">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p>
                  <button type="button" class="btn btn-primary material-button" onclick="ButtonsService.get(`+data[i].id+`)">
                    Edit material
                  </button>
